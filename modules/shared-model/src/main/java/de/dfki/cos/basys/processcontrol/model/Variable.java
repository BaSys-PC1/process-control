...
public class Variable extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<Variable> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<Variable> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<Variable> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<Variable>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this Variable to a ByteBuffer.
  ...
  /**
   * Deserializes a Variable from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a Variable instance decoded from the given buffer
  ...
  private de.dfki.cos.basys.processcontrol.model.VariableType type;
   ...
   */
  public Variable(java.lang.CharSequence name, java.lang.Object value, de.dfki.cos.basys.processcontrol.model.VariableType type) {
    this.name = name;
    this.value = value;
    this.type = type;
  }
   ...
   * @param value the value to set.
   */
  public void setType(de.dfki.cos.basys.processcontrol.model.VariableType value) {
    this.type = value;
  }

  /**
   * Creates a new Variable RecordBuilder.
   * @return A new Variable RecordBuilder
   */
  public static de.dfki.cos.basys.processcontrol.model.Variable.Builder newBuilder() {
    return new de.dfki.cos.basys.processcontrol.model.Variable.Builder();
  }

  /**
   * Creates a new Variable RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new Variable RecordBuilder
   */
  public static de.dfki.cos.basys.processcontrol.model.Variable.Builder newBuilder(de.dfki.cos.basys.processcontrol.model.Variable.Builder other) {
    if (other == null) {
      return new de.dfki.cos.basys.processcontrol.model.Variable.Builder();
    } else {
      return new de.dfki.cos.basys.processcontrol.model.Variable.Builder(other);
    }
  }

  /**
   * Creates a new Variable RecordBuilder by copying an existing Variable instance.
   * @param other The existing instance to copy.
   * @return A new Variable RecordBuilder
   */
  public static de.dfki.cos.basys.processcontrol.model.Variable.Builder newBuilder(de.dfki.cos.basys.processcontrol.model.Variable other) {
    if (other == null) {
      return new de.dfki.cos.basys.processcontrol.model.Variable.Builder();
    } else {
      return new de.dfki.cos.basys.processcontrol.model.Variable.Builder(other);
  ...
  /**
   * RecordBuilder for Variable instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Variable>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(de.dfki.cos.basys.processcontrol.model.Variable.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing Variable instance
     * @param other The existing instance to copy.
     */
    private Builder(de.dfki.cos.basys.processcontrol.model.Variable other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public de.dfki.cos.basys.processcontrol.model.Variable.Builder setName(java.lang.CharSequence value) {
    ...
    public Variable build() {
      try {
        ...
        record.type = fieldSetFlags()[2] ? this.type : (de.dfki.cos.basys.processcontrol.model.VariableType) defaultValue(fields()[2]);
        return record;
