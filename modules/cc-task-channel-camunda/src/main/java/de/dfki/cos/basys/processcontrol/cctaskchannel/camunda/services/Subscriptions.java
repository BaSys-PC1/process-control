package de.dfki.cos.basys.processcontrol.cctaskchannel.camunda.services;
...
public class Subscriptions implements ApplicationListener<SubscriptionInitializedEvent> {
    ...
    @Autowired
    public SpringTopicSubscription controlComponentHandlerSubscription;
    ...
    public void listSubscriptionBeans() {
        LOG.info("Subscription bean 'controlComponentHandlerSubscription' has topic name: {} ",
                controlComponentHandlerSubscription.getTopicName());
